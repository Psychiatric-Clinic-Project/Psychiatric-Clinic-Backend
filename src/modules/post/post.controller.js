...
import { createdSuccessfullyMessage, deletedSuccessfullyMessage, duplicateMessage, notFoundMessage, retrievedSuccessfullyMessage, updatedSuccessfullyMessage } from "../../utils/index.js";
import Response from "../../../Database/models/response.model.js";
...
export const createPost = async (req, res) => {
    ...
    return res.success(newPost, createdSuccessfullyMessage("Post"), 200);
}
...
export const getLikedPosts = async (req, res) => {
    ...
    return res.success(likedPosts, retrievedSuccessfullyMessage("Liked Posts"), 200);
}

export const getUnlikedPosts = async (req, res) => {
    const userId = req.user._id;
    const unlikedPosts = await Post.find({ unlikes: { $gt: 0 }, userId });
    return res.success(unlikedPosts, retrievedSuccessfullyMessage("Unliked Posts"), 200);
}

export const getSharedPosts = async (req, res) => {
    const userId = req.user._id;
    const sharedPosts = await Post.find({ shares: { $gt: 0 }, userId });
    return res.success(sharedPosts, retrievedSuccessfullyMessage("Shared Posts"), 200);
}

export const getPostsByCategory = async (req, res) => {
    const { category } = req.params;
    const posts = await Post.find({ category });
    return res.success(posts, retrievedSuccessfullyMessage("Posts by Category"), 200);
}
...
export const getCommentsByPost = async (req, res) => {
    ...
    return res.success(comments, retrievedSuccessfullyMessage("Comments by Post"), 200);
}
...
export const deleteComment = async (req, res) => {
    ...
    return res.success(deletedComment, deletedSuccessfullyMessage("Comment"), 200);
}
...
export const unlikeComment = async (req, res) => {
    ...
    return res.success(comment, updatedSuccessfullyMessage("Comment unlike"), 200);
}
...
export const getRepliesByComment = async (req, res) => {
    ...
    return res.success(replies, retrievedSuccessfullyMessage("Replies by Comment"), 200);
}
...
export const getSharesByPost = async (req, res) => {
    ...
    return res.success(shares, retrievedSuccessfullyMessage("Shares by Post"), 200);
}
